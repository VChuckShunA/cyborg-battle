...
void LivingEntity::updateHitBox() {
	...
	GroupBox* hitBoxes = (GroupBox*)GroupBuilder::findGroupByName("hitBox", currentFrame->frameData); //access hitbox data
...
void LivingEntity::draw() {
	...
	if (solid && Globals::debugging) {
		...
		SDL_SetRenderDrawColor(Globals::renderer, 255, 0, 0, SDL_ALPHA_OPAQUE);		SDL_RenderDrawRect(Globals::renderer, &collisionBox);
